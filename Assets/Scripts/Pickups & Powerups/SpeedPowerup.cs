...
public class SpeedPowerup : Powerup
{
    ...
    {
        normalMoveSpeed = target.GetComponent<TankPawn>().moveSpeed;
        normalTurnSpeed = target.GetComponent<TankPawn>().turnSpeed;
        ...
        target.GetComponent<TankPawn>().moveSpeed = newMoveSpeed;
        target.GetComponent<TankPawn>().turnSpeed = newTurnSpeed;
    }

    // This will remove the speed boost from the tank pawn
    public override void Remove(PowerupManager target)
    {
        target.GetComponent<TankPawn>().moveSpeed = normalMoveSpeed;
        target.GetComponent<TankPawn>().turnSpeed = normalTurnSpeed;
    }
}